...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LSFT, SE_Z,    SE_X,    SE_C,    SE_V,    SE_B,    SE_N,    SE_M,    SE_COMM, SE_DOT,  KC_UP,   KC_ENT,
  KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, _______, MU_NEXT,   AU_ON,  AU_OFF, AG_NORM, AG_SWAP,  QWERTY, COLEMAK_SE,    _______, _______, _______,
